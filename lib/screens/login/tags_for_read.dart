                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: const Border(
                          ...
                          right: BorderSide(
                              width: 5, color: corPrincipal), // Borda à direita
                          top: BorderSide(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border(
                          left: BorderSide(
                              width: 5,
                              color: corPrincipal.shade200), // Borda à esquerda
                          right: BorderSide(
                              width: 5,
                              color: corPrincipal.shade200), // Borda à direita
                          top: BorderSide(
                              width: 5,
                              color: corPrincipal.shade200), // Borda no topo
                          bottom: BorderSide(
                              width: 12,
                              color: corPrincipal.shade200), // Borda por baixo
                        ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: const Border(
                          ...
                          right: BorderSide(
                              width: 5, color: Colors.white), // Borda à direita
                          top: BorderSide(
                        ...
                        child: Column(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Text(
                                    'Escolha os tópicos que você gosta ${selectedTags.length} / $maxTags'),
                                Padding(
                            ...
                            SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => const CustomNavBarWidget(),), (route) => false);
                                  },
                                  style: ButtonStyle(
                                      foregroundColor:
